...
const LegsPig = ({ times, rotate, rotateOpp, duration, p, delay }) => (
    <>
        <motion.div style={{ left: p * 11, top: p * 8, width: p * 2, height: p * 5, transformOrigin: 'top center' }} className="absolute bg-pink-700"
            animate={{ rotate: rotateOpp }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
        <motion.div style={{ left: p * 5, top: p * 8, width: p * 2, height: p * 5, transformOrigin: 'top center' }} className="absolute bg-pink-700"
            animate={{ rotate: rotate }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
        <motion.div style={{ left: p * 12, top: p * 8, width: p * 2, height: p * 5, transformOrigin: 'top center' }} className="absolute bg-pink-600"
            animate={{ rotate: rotate }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
        <motion.div style={{ left: p * 6, top: p * 8, width: p * 2, height: p * 5, transformOrigin: 'top center' }} className="absolute bg-pink-600"
            animate={{ rotate: rotateOpp }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
    </>
);
...
const LegsPanda = ({ times, rotate, rotateOpp, duration, p, delay }) => (
    <>
        <motion.div style={{ left: p * 10, top: p * 10, width: p * 3, height: p * 6, transformOrigin: 'top center' }} className="absolute bg-black"
            animate={{ rotate: rotateOpp }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
        <motion.div style={{ left: p * 4, top: p * 10, width: p * 3, height: p * 6, transformOrigin: 'top center' }} className="absolute bg-black"
            animate={{ rotate: rotate }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
        <motion.div style={{ left: p * 11, top: p * 11, width: p * 3, height: p * 6, transformOrigin: 'top center' }} className="absolute bg-black"
            animate={{ rotate: rotate }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
        <motion.div style={{ left: p * 5, top: p * 11, width: p * 3, height: p * 6, transformOrigin: 'top center' }} className="absolute bg-black"
            animate={{ rotate: rotateOpp }} transition={{ duration, repeat: Infinity, times, ease: "linear", delay }} />
    </>
);
