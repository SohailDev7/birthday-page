  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setLoadingProgress(prev => {
        // If audio not ready yet, hold at 95%
        if (!audioPreloaded && prev >= 95) {
          return 95;
        }
        ...
        // Progress speed: Random normally, faster if audio is done
        return prev + (audioPreloaded ? 5 : Math.random() * 10);
      });
    }, 100);
